...
import { STREAM_SCHEMA, streamContract, streamGoldenVectors } from "./stream.contract.ts";
...
export const CONTRACT_REGISTRY: ContractEntry[] = [
  ...
  { schema: STREAM_SCHEMA, contract: streamContract, vectors: streamGoldenVectors },
