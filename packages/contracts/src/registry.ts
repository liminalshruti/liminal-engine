...
import { TRACE_EVENT_SCHEMA, traceEventContract, traceEventGoldenVectors } from "./trace-event.contract.ts";
...
export const CONTRACT_REGISTRY: ContractEntry[] = [
  ...
  { schema: TRACE_EVENT_SCHEMA, contract: traceEventContract, vectors: traceEventGoldenVectors },
